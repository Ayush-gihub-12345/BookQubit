    ...
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      {data.totalBooks === 0 ? (
        <div className="card mt-8 p-10 text-center hover:!translate-y-0">
          ...
          <Link href={`/${lang}/books`} className="btn-primary mt-4 inline-flex">{tr("browseBooksLabel")}</Link>
        </div>
      ) : (
        <>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            {data.topRatedBook && (
              <Link href={`/${lang}/books/${encodeURIComponent(data.topRatedBook.book_slug)}`} className="card flex gap-4 p-4 hover:!translate-y-0">
            ...
            {data.longestBook && (
              <Link href={`/${lang}/books/${encodeURIComponent(data.longestBook.book_slug)}`} className="card flex gap-4 p-4 hover:!translate-y-0">
                <div className="h-28 w-20 shrink-0 overflow-hidden rounded-lg shadow">
